...
class CASLowAsk:
    ...
    def schedule_if_ready(self, rec: dict) -> None:
        ...
        # Global blocks: H01/02/03/04/05/08 negative; H12 EV=-0.093; H14 user; H16 EV=-0.157
        # H04/05 added 2026-05-18: negative at THR=0.02; H01 blocked user instruction
        hour_utc = datetime.fromtimestamp(wend, tz=timezone.utc).hour
        if hour_utc in [1, 2, 3, 4, 5, 8, 12, 14, 16]:
            return
