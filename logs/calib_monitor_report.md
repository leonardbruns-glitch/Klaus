# Calib Monitor Report — 2026-07-30

**STALL — systemd failed/unknown. Pipeline aborted. Day 7 consecutive abort.**
...
Bot last active: 2026-07-24T10:09:19 UTC (~142h dead as of run time).
Owner-directed shutdown 2026-07-24; daily+liveness timers disabled; loop weekly-only.
Snapshot: 2026-07-30T08:08:06Z (fresh, ~4 min old). Data mirror is updating; service is not.
...
**THE DISPERSION EDGE IS INVERTED. Day 28 consecutive (estimate).**
...
0/6 days above threshold. 07-24 through 07-30 not computed (system down).
No trend improvement to report. Alert persists at decision-grade n~105.

Note: BAND_LIVE=False since 2026-07-06 (day 24 dark). The live halt predates this monitor
...
| Item | Value |
|---|---|
| Deployed refit date | 2026-06-06T22:27:08Z (~54d stale) |
| Candidate refit date | 2026-07-23T09:30:44Z (~7d old) |
...
| Field | 07-29 | 07-30 | Transition |
|---|---|---|---|
| pipeline_status | ABORTED | ABORTED | day 6 → day 7 consecutive abort |
| system_alive | false | false | systemd still failed/unknown |
| disp_inversion_days | 27 (est) | 28 (est) | +1, no reversal |
| BAND_LIVE | False | False | day 23 → day 24 dark |
| isotonic deployed age | ~53d | ~54d | +1d stale |
| bot_dead_hours | ~118h | ~142h | +24h |

---

## ALERTS

**[SYSTEM]** `## klaus systemd: failed/unknown` — pipeline aborted. Snapshot fresh (2026-07-30T08:08:06Z, ~4 min old). Bot last active: 2026-07-24T10:09:19 UTC (~142h / ~6 days dead). Owner-directed shutdown; daily+liveness timers disabled. Day 7 consecutive abort.

**[S3 CARRIED — PRE-REGISTERED]** `disp_ratio7 = 0.781 < 1.10` — INVERTED DISPERSION EDGE — day 28 consecutive (estimate) — decision-grade n~105 — all 3 regions below 1.0 — 0/6 days above threshold in last computed window (07-18..07-23). Fresh data unavailable; alert persists.

**[S4 CARRIED — PRE-REGISTERED]** Isotonic deployed ~54d stale (2026-06-06); candidate 2026-07-23 with 2 material tail diffs (grid 0.95: +0.055, grid 1.0: +0.168); OOS brier_cal >= brier_raw; human review required before any promotion.
