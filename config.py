...
class BankrollConfig:
    ...
    base_stake: float = 4.0           # 2026-04-30 (user directive: 10→4, capital preservation; bankroll $50.48 near $50 ruin floor)
    # Scale-up tiers (static sizing — Kelly deferred until n≥50 with stable per-regime WR):
    #   Tier 1: $4 — now active (reduced from $10 2026-04-30)
    #   Tier 2: $10 — after confirmed WR>55% over 20+ live trades
