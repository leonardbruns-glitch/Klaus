...
class BankrollConfig:
    ...
    base_stake: float = 3.0           # 2026-04-23 (user directive: 10→3, test new vel-quality + stab gates)
    ...
    scaled_stake: float = 3.0         # flat — heat-check disabled; raise per tiers above
