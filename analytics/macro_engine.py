...
class MacroEngine:
    ...
    async def bond_advisor(
        ...
        system_prompt = (
            ...
            "---\n\n"
            "Before making a decision, you MUST evaluate BOTH sides:\n\n"
            ...
            "   - Is current price underestimating that probability?\n\n"
            "Then compare which side is more mispriced.\n\n"
            "Do NOT base your decision on current price movement alone.\n\n"
            "---\n\n"
            "Hard rule: If your reasoning includes phrases like:\n"
            "- 'negative delta'\n"
            "- 'no acceleration'\n"
            "- 'momentum is weak'\n\n"
            "you must treat it as insufficient and continue analysis.\n\n"
            "You are not a momentum trader. You are a probability arbitrage engine under time constraint.\n"
            "Your job is to find mispriced probabilities — not to follow signals."
        )
